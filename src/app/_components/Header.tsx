    ...
    <nav className='w-full h-[100px] bg-black flex items-center justify-center sticky top-0 left-0 z-50 relative'>
        <div className='flex justify-between w-[80%] max-lg:w-[85%] mx-auto h-fit items-center'>
            ...
            <div className='text-white flex gap-8 h-fit w-fit tracking-wide text-sm max-xl:text-xs max-xl:hidden '>
                ...
                <p className={`${active === "book" ? "text-red-500" : "text-white"} cursor-pointer hover:text-red-500`}>BOOK A STAND</p>
                <p className={`${active === "partnership" ? "text-red-500" : "text-white"} cursor-pointer hover:text-red-500`}>PARTNERSHIP</p>
                <p className={`${active === "about" ? "text-red-500" : "text-white"} cursor-pointer hover:text-red-500`}>ABOUT</p>
                <p className={`${active === "contact" ? "text-red-500" : "text-white"} cursor-pointer hover:text-red-500`}>CONTACT US</p>
