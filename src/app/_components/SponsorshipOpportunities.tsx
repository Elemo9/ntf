...
function SponsorshipOpportunities() {
  return (
    <div className='h-fit py-36 w-full items-center justify-center bg-black'>
        <div className='flex max-lg:flex-col max-lg:gap-6 w-[80%] max-lg:w-[85%] justify-between mx-auto'>
            ...
            <motion.div 
                ...
                whileInView={"show"}
                viewport={{once:false, amount:0.3}}
                className='w-[48%] h-fit max-lg:w-full flex flex-col gap-4 justify-center '>
